...
```yaml
# .github/workflows/korreview.yml
name: KorReview
on:
  pull_request:
...
- 버그 리포트: [Issues](https://github.com/korreview/korreview/issues)
- 기능 제안: [Discussions](https://github.com/korreview/korreview/discussions)

---

*KorReview — 한국 개발자를 위해, 한국 개발자가 만든 코드 리뷰 도구*
